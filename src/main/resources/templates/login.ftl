...
<head>
    ...
    <link href="/assets/verify-code/font-awesome_4.4.0/font-awesome.css" rel="stylesheet"/>
    <link href="/assets/css/style.css" rel="stylesheet">
    <link href="/assets/verify-code/verify.css" rel="stylesheet"/>
...
<script src="/assets/verify-code/verify-code.js"></script>
<script>
    $(function(){
        //执行滑动验证码方法
