...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li style="margin-left: 60px"><a href="user.html">唐十三</a></li>
            <li><a href="#">退出</a></li>
        </ul>
    </div>
</nav>
    ...
    <div class="row" style="margin-top: 30px">
        <div class="col-md-2">
            <div class="list-group">
                <a href="user.html" class="list-group-item">个人资料</a>
                <a href="course.html" class="list-group-item active">我的课程</a>
            </div>
        </div>
        <div class="col-md-10">
